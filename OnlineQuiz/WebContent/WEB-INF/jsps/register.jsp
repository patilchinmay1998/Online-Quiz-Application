...
function formValidation()
{
	...
	/*String str = document.getElementById("email").value.toString();
	if(!(str.contains("@") && str.contains(".") && (str.contains("gmail") || str.contains("yahoo")))){
		alert("invalid email");
		return false;
	}
	String ss = document.getElementById("mobile").value.toString();
	if(!(ss.length() == 10)){
